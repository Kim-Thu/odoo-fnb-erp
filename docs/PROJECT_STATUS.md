...
| Task đang active | T2012 — Test reset approval sau khi đổi order line |
| Branch | `test/T2012-reset-order-line-20260812-0225` |
| PR | Chưa mở — sẽ mở sau commit |
| PR state | Chưa có |
| CI gần nhất | T2011/PR #35 green và đã merged |
...
| Phase 2 — Purchase / Procure-to-Stock | 🔵 Đang triển khai | Purchase approval T2001–T2011 done; T2012 đang review; T2013–T2016 và T2101–T2106 còn todo |
...
Sau khi T2012 merge, chọn task Phase 2 nhỏ nhất có dependency đã `done`; hiện ứng viên kế tiếp là T2013.
...
- T2011 đã bổ sung regression evidence vendor change reset approval cho BR-02 / FR-PUR-02; mapping RTM vẫn T2001–T2016.
- T2012 bổ sung regression evidence order-line change reset approval cho BR-02 / FR-PUR-02; RTM mapping không đổi.
...
- [x] T2011/PR #35 đã merge và CI xanh.
- [x] Chỉ có một task nghiệp vụ active: T2012.
- [x] Dependency T2006 của T2012 đã `done`.
- [x] T2012 nằm trong mapping BR-02 / FR-PUR-02; RTM chưa cần đổi.
